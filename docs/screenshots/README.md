...
| File | Screen |
| --- | --- |
| `folders.png` | Folder list with note counts |
| `notes-list.png` | All Notes, including a pinned note |
| `note-reading.png` | Reading view with rendered Markdown |
| `note-drawing.png` | Reading view showing an attached drawing |
